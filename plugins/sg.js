...
Asena.addCommand({pattern: 'sg ?(.*)', fromMe: true, onlyGroup: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
    ...
    if (Config.BANMSG == 'default') {
        if (message.reply_message !== false) {
            ...
            await message.client.sendMessage(
                ...
                fs.readFileSync("/root/WhatsAsenaDuplicated/media/gif/VID-20210702-WA0029.mp4"),
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: "Ali Bey Tarafından Gurupdan Sg Olundunuz!" }
            )
            await message.client.sendMessage(message.jid,'```Ali Bey Tarafından Sikildin 🥵``` ' + etiketler + '👾', MessageType.text, {contextInfo: {mentionedJid: message.mention}});
