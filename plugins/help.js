...
const h_Des = "Ali Bey Yardım menüsünden botu kullanım hakkında bilgi verir."
...
const notfound = "```Ali Bey Almak istediğiniz yardım bulunamadı!```\n```Ali Bey Lütfen daha açıklayıcı bir şekilde sorunu belirtin.```"
const notfoundEN = "```Mr Ali The help you wanted to get was not found!```\n```Mr Ali Please state the problem in a more descriptive way.```"

// ==================== ALL DESCRİPTİONS ====================
const pubTR = "Ali Bey Botunuzu public yapmak komutları herkese açık yapacaktır. Public yapıldıktan sonra kullanıcı sadece kişisel ve admin komutlarını kullanabilir hale gelir. Onun dışında komutları kullanamaz.\nBotunuzu public yapmak için *.setvar WORK_TYPE:public* komutunu kullanın."
...
const privTR = "Ali Bey Botunuzu private yapmak komutları sadece size özel yapar. Başkaları kullanamaz.\nBotunuzu private yapmak için *.setvar WORK_TYPE:private* komutunu kullanın."
